                            ...
                            <div class="caption">
                                ...
                                <div class="actions pull-right">
                                    <a href="{{ route("department.create") }}" class="btn btn-primary">
                                        ...
                                        <span class="hidden-480">Add Department</span>
                                    </a>
                                </div>
                            </div>
            ...
            var table = $datatable.DataTable({
                ...
                "columns": [
                    ...
                    {"data": "created_at"},
                    {
                        ...
                        "className": "center",
                        "render": function(id){
                            var s = '<a class="btn btn-info btn-sm" href="{{ url("/department" ) }}/'+id+'/edit"><i class="fa fa-edit"></i> Edit</a>&nbsp;';
                            s = s + `<button class="btn btn-sm btn-danger" onclick="deleteObj(${id})"><i class="fa fa-trash-o"></i> Delete</button>`;
                            s+=`<form id="form`+id+`" style="display:none" action="/department/${id}" method="POST">@csrf @method("DELETE")</form>`;
                            return s;
                        }
                    }
                ],
                ...
                'serverSide': true,
                'ajax': {
                    'url': '{{ route("department-list-ajax") }}',
                    'type': 'POST'
                },
                'order': [[ 0, 'desc' ]],
                'columnDefs': [
