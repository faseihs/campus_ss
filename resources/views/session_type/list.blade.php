                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="caption">
                                <i class="fa fa-globe"></i> Session
                                <div class="actions pull-right">
                                    <a href="{{ route("session.create") }}" class="btn btn-primary">
                                        <i class="fa fa-plus"></i>
                                        <span class="hidden-480">Add Session</span>
                                    </a>
                                </div>
                            </div>
            ...
            var table = $datatable.DataTable({
                ...
                "columns": [
                    ...
                    {"data": "created_at"},
                    {
                        ...
                        "className": "center",
                        "render": function(id){
                            var s = '<a class="btn btn-info btn-sm" href="{{ url("/session" ) }}/'+id+'/edit"><i class="fa fa-edit"></i> Edit</a>&nbsp;';
                            s = s + `<button class="btn btn-sm btn-danger" onclick="deleteObj(${id})"><i class="fa fa-trash-o"></i> Delete</button>`;
                            s+=`<form id="form`+id+`" style="display:none" action="/session/${id}" method="POST">@csrf @method("DELETE")</form>`;
                            return s;
                        }
                    }
                ],
